...
package io.fabric8.apps.gerrit;
...
public class GerritKubernetesTest {
    ...
    @Test
    public void testGerrit() throws Exception {
      	assertThat(client).replicationControllers().haveAtLeast(1, new Condition<ReplicationController>() {
	        ...
	        public boolean matches(ReplicationController replicationController) {
	            return getName(replicationController).startsWith("gerrit");
	        }
      	});
