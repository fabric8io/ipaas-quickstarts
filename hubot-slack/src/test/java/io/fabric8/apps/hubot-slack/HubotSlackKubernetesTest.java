...
package io.fabric8.apps.hubotslack;
...
public class HubotSlackKubernetesTest {
    ...
    @Test
    public void testHubotSlack() throws Exception {
      	assertThat(client).replicationControllers().haveAtLeast(1, new Condition<ReplicationController>() {
	        ...
	        public boolean matches(ReplicationController replicationController) {
	            return getName(replicationController).startsWith("hubot-slack");
	        }
      	});
