...
1. Change your working directory to `quickstarts/karaf/beginner/camel-log-wiki` directory.
...
quickstarts/karaf/beginner/-camel.log.wiki` profile in a single step, by entering the
 following command at the console:

        fabric:container-create-child --profile quickstarts-karaf-beginner
quickstarts/karaf/beginner/-camel.log.wiki root mychild
...
1. Select `quickstarts` --> `karaf` --> `beginner` --> `camel.log.wiki`
