# Web MVC IP Address with Spring-Boot QuickStart
...
The quickstart uses Spring Boot to configure a little Spring MVC application that offers a REST service which returns IP address to show service load-balancing
