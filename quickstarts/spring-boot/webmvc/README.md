...
![Spring Boot MVC](https://raw.githubusercontent.com/fabric8io/fabric8/1.x/docs/images/spring-boot-mvc.png)
...
1. Change your working directory to `quickstarts/spring-boot/webmvc` directory.
...
1. Select `quickstarts` --> `spring-boot` --> `webmvc`
...
```
	...
	19d5280bf22e        dockerhost:5000/quickstart/quickstart/springboot-webmvc:2.2-SNAPSHOT   /bin/sh -c 'java $JA   3 days ago          Up 28 minutes                                k8s_quickstart-java-simple-fatjar.6c2fc62f_c6fa4631-588f-11e4-8746-406c8f215ad7.etcd_c6fa4631-588f-11e4-8746-406c8f215ad7_e28ca78b
```
1. Use `docker logs -f <CONTAINER ID>` to see what the Spring Boot app is writing to the console, and
