...
public final class CrmTest {
    ...
    public static final String PREFIX = "http://dockerhost:9901/war-cxf-cdi-servlet-2.0.0-SNAPSHOT/";
    public static final String CUSTOMER_TEST_URL = PREFIX + "cxfcdi/customerservice/customers/123";
    public static final String PRODUCT_ORDER_TEST_URL = PREFIX + "cxfcdi/customerservice/orders/223/products/323";
    public static final String CUSTOMER_SERVICE_URL = PREFIX + "cxfcdi/customerservice/customers";
