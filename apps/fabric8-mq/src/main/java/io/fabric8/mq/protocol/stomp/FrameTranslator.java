...
public interface FrameTranslator {
    ...
    ActiveMQMessage convertFrame(StompProtocolConverter converter, StompFrame frame) throws JMSException, ProtocolException;

    StompFrame convertMessage(StompProtocolConverter converter, ActiveMQMessage message) throws IOException, JMSException;

    String convertDestination(StompProtocolConverter converter, Destination d);

    ActiveMQDestination convertDestination(StompProtocolConverter converter, String name, boolean forceFallback) throws ProtocolException;
    ...
    final class Helper {
        ...
        public static void copyStandardHeadersFromMessageToFrame(StompProtocolConverter converter, ActiveMQMessage message, StompFrame command, FrameTranslator ft) throws IOException {
        ...
        public static void copyStandardHeadersFromFrameToMessage(StompProtocolConverter converter, StompFrame command, ActiveMQMessage msg, FrameTranslator ft) throws ProtocolException, JMSException {
            final Map<String, String> headers = new HashMap<>(command.getHeaders());
