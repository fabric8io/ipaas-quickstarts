            ...
            try {
                Response response = command.visit(new CommandVisitorAdapter() {
                    public Response processMessage(Message send) throws Exception {
                        if (MessageInterceptorRegistry.getInstance(CamelRouter.REGISTRY_NAME).processCommand(DefaultMessageRouter.this, send)) {
                            return RESPONSE;
                        }
                        return null;
                    }
                    ...
                    public Response processMessageDispatch(MessageDispatch dispatch) throws Exception {
                        if (MessageInterceptorRegistry.getInstance(CamelRouter.REGISTRY_NAME).processCommand(DefaultMessageRouter.this, dispatch)) {
                            return RESPONSE;
                        }
                        return null;
                    }
                    ...
                    public Response processAddConsumer(ConsumerInfo info) throws Exception {
                        if (MessageInterceptorRegistry.getInstance(CamelRouter.REGISTRY_NAME).processCommand(DefaultMessageRouter.this, info)) {
                            return RESPONSE;
                        }
                        return null;
                    }
                    ...
                    public Response processMessageAck(MessageAck ack) throws Exception {
                        if (MessageInterceptorRegistry.getInstance(CamelRouter.REGISTRY_NAME).processCommand(DefaultMessageRouter.this, ack)) {
                            return RESPONSE;
                        }
                        return null;
                    }
