...
public class AppSummaryDTO {
    ...
    public void setPods(List<AppPodSummaryDTO> pods) {
        this.pods = pods;
    }
    ...
    public void setReplicationControllers(List<AppReplicationControllerSummaryDTO> replicationControllers) {
    ...
    public void setServices(List<AppServiceSummaryDTO> services) {
